...
<form method="POST">
    <div class="grid grid-cols-6 grid-rows-2 gap-4">
        ...
        <div class="block col-start-3 col-end-5">
            ...
            <input type="text" id="emission_factor" placeholder="Example (You can only use AWS) : us_west_1" name= "emission_factor"  class="bg-gray-50 border border-pine-green text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
        </div>
        ...
        <div class="row-start-2 col-start-4 col-end-6">
            ...
            <input type="number" step=0.01 max=1 min=0 id="per_load" name="per_load" value=1 class="bg-gray-50 border border-pine-green text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-1/2 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" disabled>
        </div>
    ...
    <div class="grid grid-cols-3">
        <div class="col-start-2 justify-self-center mt-5">
            <div>
                ...
                <input type="number" name="time_active" class="bg-gray-50 border border-pine-green text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-1/8 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            </div>
        </div>
    </div>
